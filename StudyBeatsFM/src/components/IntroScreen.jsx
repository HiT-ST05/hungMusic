  ...
  return (
    <div>
      ...
      <div className="titleContainer">
        ...
        <h1 className="tracking-in-expand-fwd">Kim Hưng Music</h1>
        <h3 className="subTitle"> Web nhạc thay đổi tâm trạng </h3>
        ...
        <div class="wrap">
          <Link to="/music">
            <button class="button">Ấn Vào Đây Để Nghe</button>
          </Link>
        </div>
      </div>
      <ReactPlayer
